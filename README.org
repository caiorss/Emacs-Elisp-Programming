...
Emacs key bindings and commands for Elisp (Emacs' lisp) development. 
 ...
 - [[file:Command_Line_and_Scripting.org][Command Line and Scripting]]

Command line interaction with Emacs.
...
Eshell - Multi-platform unix shell written in Elisp highly integrated
with Emacs and with several platform independent shell commands such
