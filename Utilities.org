...
Example: Compiling and running a F# script. To see the image
fullscreen open: http://imgur.com/a/7Hvrz and click at the image.
...
That runs a F# script performing a syntax check before run, therefore
as it is compiled language all syntax errors and value errors will
appear at the compilation buffer.
...
file:images/utilities-manpage.png
...
file:images/utilities-infopage-root.png


file:images/utilities-infopage-tramp.png
