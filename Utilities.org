...
|-------------------------------+-------------------------+--------------------------------------------------------------|
| Emacs interal tutorial        | help-with-tutorial      | Open Emacs tutorial.                                         |
|                               |                         |                                                              |
...
Note: 
 ...
 - To Emacs' tutorial (help-with-tutorial) work the cua-mode must be
   disabled (M-x cua-mode to disable it).
...
The code block bellow will set the key bindings as shown in the
following tables:
