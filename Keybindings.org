...
Note: _EVIL_ - Is not what it seems. It stands for _Extensible VI
Layer_. I this case "evil is good". It is an Emacs mode to emulate VI
...
| <n>\vert             | Got to to column n, '10\vert' got to column 10. |
|----------------------+-------------------------------------------------|
| *Word*               |                                                 |
...
| :ls                  | List buffers.                                         |
 ...
 - [[http://www.saltycrane.com/blog/2015/12/switching-emacs-vim-actually-spacemacs/][Switching from Emacs to Vim (actually Spacemacs) - SaltyCrane Blog]]

 - [[http://irreal.org/blog/?p=259][Emacs Keybindings for Mac OS X | Irreal]]
     
 - [[https://www.emacswiki.org/emacs/Evil][EmacsWiki: Evil]] 
    
 - [[http://wikemacs.org/wiki/Evil][Evil - WikEmacs]]

 - [[http://blog.jakubarnold.cz/2014/06/23/evil-mode-how-to-switch-from-vim-to-emacs.html][Evil Mode: How I Switched From VIM to Emacs - Jakub Arnold Blog]] 

 - [[http://jen20.com/2015/02/06/configuring-emacs-for-go-part-1.html][Configuring emacs and evil mode for Go development (Part 1)]] 

 - [[https://medium.com/@bryangarza/my-descent-into-evil-98f7017475b6#.y23kjqn3e][My Descent Into Evil – Medium]] 

 - [[https://nathantypanski.com/blog/2014-08-03-a-vim-like-emacs-config.html][Towards a Vim-like Emacs]]

Evil Mode Manual: 

 - [[wiki-asset-sys:Emacs;evil-manual1.pdf][evil-manual1.pdf]]
